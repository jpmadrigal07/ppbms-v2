...
router.post("/", async (req, res) => {
    ...
    if (!_.isNil(messengerId) && !_.isNil(encodeListId) && !_.isNil(sender) && !_.isNil(delType) && !_.isNil(pud) && !_.isNil(month) && !_.isNil(year) && !_.isNil(jobNum) && !_.isNil(checkList) && !_.isNil(fileName) && !_.isNil(seqNum) && !_.isNil(cycleCode) && !_.isNil(qty) && !_.isNil(address) && !_.isNil(area) && !_.isNil(subsName) && !_.isNil(barCode) && !_.isNil(acctNum) && !_.isNil(dateRecieved) && !_.isNil(recievedBy) && !_.isNil(relation) && !_.isNil(messenger) && !_.isNil(status) && !_.isNil(reasonRTS) && !_.isNil(remarks) && !_.isNil(dateReported)) {
